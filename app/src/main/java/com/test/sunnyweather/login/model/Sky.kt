...
private val sky = mapOf(
    ...
    "LIGHT_RAIN" to Sky("小雨",R.drawable.ic_light_rain,R.drawable.ic_light_rain),
    ...
    "HAIL" to Sky("冰雹",R.drawable.ic_hail,R.drawable.ic_hail),
